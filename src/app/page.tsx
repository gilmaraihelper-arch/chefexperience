          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/criar-evento" className="hover:text-amber-400 transition-colors">Publicar Evento</Link></li>
                <li><Link href="/dashboard/cliente" className="hover:text-amber-400 transition-colors">Meus Eventos</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/cadastro/profissional" className="hover:text-amber-400 transition-colors">Cadastrar</Link></li>
                <li><Link href="/dashboard/profissional" className="hover:text-amber-400 transition-colors">Dashboard</Link></li>
              </ul>
            </div>
