    ...
    try {
      ...
      if (data.events) {
        const eventosFormatados = data.events.map((e: any) => ({
          id: e.id,
          evento: e.evento || e.name,
          cliente: e.cliente || 'Cliente',
          email: e.email,
          phone: e.phone,
          data: e.data || e.date,
          pessoas: e.pessoas || e.guestCount,
          valor: e.valor || e.hiredProposal?.totalPrice,
          local: e.local || e.city,
          status: 'confirmado',
          // Todos os detalhes extras
          ...
          city: e.city,
          state: e.state,
          hasKitchen: e.hasKitchen,
          priceRange: e.priceRange,
          maxBudget: e.maxBudget,
          cuisineStyles: e.cuisineStyles,
          serviceTypes: e.serviceTypes,
          description: e.description,
          dietaryRestrictions: e.dietaryRestrictions,
          needsWaiter: e.needsWaiter,
          needsSoftDrinks: e.needsSoftDrinks,
          needsAlcoholicDrinks: e.needsAlcoholicDrinks,
          needsDecoration: e.needsDecoration,
          needsSoundLight: e.needsSoundLight,
          needsPhotographer: e.needsPhotographer,
          needsBartender: e.needsBartender,
          needsSweets: e.needsSweets,
          needsCake: e.needsCake,
          needsPlatesCutlery: e.needsPlatesCutlery,
        }));
